...
# Due to mtk will include more than one, so remove this limitation
...
$(reqd_policy_mask.conf): $(call build_policy, $(sepolicy_build_files), $(REQD_MASK_POLICY))
	...
	$(hide) m4 $(PRIVATE_ADDITIONAL_M4DEFS) \
		...
		-D target_build_variant=$(patsubst userdebug,eng,$(TARGET_BUILD_VARIANT)) \
...
#$(TARGET_BUILD_VARIANT)  $(patsubst userdebug,eng,$(TARGET_BUILD_VARIANT))
